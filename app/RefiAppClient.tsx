...
export default function RefiAppClient() {
  const searchParams = useSearchParams();
  const address = searchParams.get('address');
  console.log(address);
  const [poolAddress, setPoolAddress] = useState<PublicKey | null | undefined>(address ? new PublicKey(address) : null);
  ...
  return (
    <div className="app">
      ...
      {/* ===== DASHBOARD ===== */}
      {
        view == 'dashboard' && <TokenDashboard poolAddress={poolAddress} />
      }
      {view === null && (
        <div className="text-center py-12" id="dLoading">
          <div className="m-auto mt-5 w-10 h-10 border-2 border-gray-300 border-t-purple-500 rounded-full animate-spin mx-auto mb-4"></div>
